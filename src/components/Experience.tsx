...
const TIMELINE: TimelineItem[] = [
  {
    ...
    current: false,
    description: [
      'Developed client-facing frontend features and integrated REST APIs for complex data workflows, contributing to a 40% improvement in application data reliability.',
      'Collaborated with backend engineers to improve production data synchronization, performing code reviews and implementing technical feedback to reduce synchronization errors.',
      'Identified production performance bottlenecks and shipped optimized pull requests, reducing average response latency by 25%.',
    ],
  },
  {
    id: 'rishihood',
    ...
    description: [
      'Cumulative Grade Point Average (CGPA): 8.72',
      'Relevant Coursework: Object-Oriented Programming (OOP), Data Structures and Algorithms (DSA), Operating Systems (OS), Computer Networks, DBMS.',
